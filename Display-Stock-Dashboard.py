...
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8 = st.tabs(["Final Score", "P/E Ratio", "Free Cash Flow", "Sharpe Ratio", "Momentum_1m_Score", "Momentum_3m_Score", "Volatility_30d_Score", "Trend_50_200_Score"])
